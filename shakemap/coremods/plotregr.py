    ...
    def execute(self):
        ...
        for myimt in imtlist:
            ...
            if myimt == 'MMI':
                ...
                self.contents.addFile('pgdRegr', 'PGD Regression',
                                      'Regression plot of peak ground '
                                      'displacement (cm).',
                                      'pgd_regr.png', 'image/png')
            elif myimt == 'IA':
                self.contents.addFile('iaRegr', 'Arias Regression',
                                      'Regression plot of Arias'
                                      '(cm/s).',
                                      'ia_regr.png', 'image/png')
            elif myimt == 'IH':
                self.contents.addFile('ihRegr', 'Housner Regression',
                                      'Regression plot of Housner '
                                      '(cm).',
                                      'ih_regr.png', 'image/png')
            else:
